...
export default function ImageCard({
  ...
  const previewUrl = getFullUrl(
    isGif ? image.url : image.urls?.thumb || image.urls?.webp || image.url
  );
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              onClick={(e) => {
                e.stopPropagation();
                copyToClipboard(getFullUrl(image.urls?.webp || image.url)).then((success) => {
